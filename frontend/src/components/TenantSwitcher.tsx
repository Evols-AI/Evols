  ...
  return (
    <div className="relative px-2 pt-1 pb-2 border-b mb-1" style={{ borderColor: 'hsl(var(--border))' }}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground hover:bg-muted rounded-lg transition-colors w-full"
        disabled={switching}
      >
      ...
      {showDropdown && (
        <div className="absolute left-0 mt-2 w-64 bg-card rounded-lg shadow-lg border border-border py-1 z-50">
