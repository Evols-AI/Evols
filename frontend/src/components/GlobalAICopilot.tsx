/**
 * GlobalAICopilot — Accessible from any page via header button
...
export default function GlobalAICopilot({ onClose }: GlobalAICopilotProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '0',
      role: 'assistant',
      content: 'Hi! I\'m your AI copilot. Ask me anything about your product, customers, or decisions — I\'ll answer from your knowledge graph with full citations.',
      timestamp: new Date(),
    }
  ])
  ...
  return (
    <div className="fixed right-0 top-[73px] h-[calc(100vh-73px)] w-96 flex flex-col border-l border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-2xl z-40">
      {/* Header */}
