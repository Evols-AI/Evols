...
description: "When GitHub's rate-limiting bug was fixed in 2026, developers discovered they had been hitting caps all along. The real problem is that no team has visibility into collective AI capacity before work stops."
date: 2026-04-11
...
![Developer frustrated at a laptop as an AI session hits a rate limit mid-task, losing hours of accumulated context](https://cdn-images-1.medium.com/max/1600/0*_XCXzHYqBHUidsZT)
...
![Bar chart showing uneven token utilization across a 10-person team: some at 95%, others below 10%](https://cdn-images-1.medium.com/max/1600/1*F5DbWzUF_IN2obx8nYRELw.png)
...
![Engineering manager reviewing team AI spend data, discovering that heavy users hit limits while lighter users expire quota daily](https://cdn-images-1.medium.com/max/1600/0*h37ApdnW_eKeZBfF)
...
![Team AI capacity dashboard showing real-time utilization, redistribution opportunities, and background task queue status](https://cdn-images-1.medium.com/max/1600/0*q1r736-QlbunMryy)
