...
description: "Identify and prioritize assumptions using an Impact × Risk matrix and suggest experiments for each. Use when triaging a list of assumptions, deciding what to test first, or mapping unknowns."
roles: [pm, founder]
---

## Assumption Manager

Identify and triage assumptions using an Impact × Risk matrix and suggest targeted experiments.
...
The user will provide a problem or a list of assumptions to prioritize. Apply the following framework:

0. **Identify Assumptions (If not provided)**:
   - **Desirability**: Do customers want this?
   - **Viability**: Should we build this (business impact)?
