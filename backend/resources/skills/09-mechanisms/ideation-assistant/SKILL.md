...
description: "Collaborative ideation for PM work — features, experiments, strategies, solutions. Context-aware for new (0-to-1) vs existing products, and feature ideas vs experiment designs. Use when doing creative work, exploring options, or turning a vague idea into a concrete plan."
roles: [pm, engineer, designer, founder]
---
...
### Phase 1: Establish Context & Understand the Problem

First, identify the context of the ideation session:
- **Product Stage**: Is this for a **new product (0-to-1)** or an **existing product (optimization/expansion)**?
- **Goal Type**: Are we brainstorming **feature ideas** or **experiments/tests**?

Then, ask one question at a time to understand:
