---
name: strategy-connector
description: "Help PMs map any work item (feature, experiment, initiative) to strategic goals and OKRs. Use before PRDs, backlog prioritization, or planning."
roles: [pm]
---
...
- Pull from `knowledge/_template/strategy.md` (or your org's strategy doc)
- Identify: strategic pillars, OKRs, key metrics, target segments
...
Reference: `knowledge/_template/strategy.md` for strategic context structure.
