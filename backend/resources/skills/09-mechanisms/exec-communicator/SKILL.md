...
description: "Help PMs write clear, executive-ready communications. Use for status updates, escalations, decision requests, launch announcements, or leadership briefings."
roles: [pm, founder]
---
...
### 3. Apply BLUF & Clear Writing Principles

- **Lead with the "so what"** — one sentence summary first
- **Plain Language** — write for a primary school reading level. No jargon. No corporate speak.
...
- **Grammar & Tone Check** — Ensure professional, error-free phrasing and an objective tone.
...
A polished, executive-ready communication in the requested format. Scannable, specific, and action-oriented. Ready to paste into email, Slack, or a deck.
