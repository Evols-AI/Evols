...
roles: [pm, designer, marketing]
---

# Customer Profiling

## Purpose
Create detailed, actionable customer profiles from research data. This skill generates research-backed User Personas (for B2C or general use) and Ideal Customer Profiles (ICPs, for B2B), complete with jobs-to-be-done, pain points, desired outcomes, and unexpected behavioral insights.
...
For each of the 3 profiles (Personas or ICPs), provide:

**Profile Name & Demographics / Firmographics**
- If B2C (Persona): Age range, role, key characteristics
- If B2B (ICP): Company size, industry, target titles, revenue, tech stack
