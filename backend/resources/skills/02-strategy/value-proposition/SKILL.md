...
roles: [pm, founder, sales, marketing]
---
# Value Proposition
...
9. Generate specific value proposition statements for marketing, sales, and onboarding (see Statement Framework below)

### Statement Framework for Marketing, Sales & Onboarding
For each target segment, generate variations of the value proposition statement that:
- Directly address the specific segment or use case
- Emphasize the primary benefit and desired outcome
- Highlight the key features and capabilities that make it possible
- Example (Canva for Social Media Marketers): "Canva empowers social media marketers to create stunning, on-brand designs effortlessly, without requiring expensive design software. Quickly produce professional-quality graphics that boost engagement."

### Domain Context

**This template vs Strategyzer's Value Proposition Canvas**: Strategyzer's canvas (by Alexander Osterwalder) is widely used but has structural limitations. This 6-part JTBD template (by Akshay Saraswat and Aatir Abdul Rauf) addresses them:
